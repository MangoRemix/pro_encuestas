            ...
            <div class="w-full p-6 space-y-6">
                ...
                <form @submit.prevent="login" class="space-y-4">
                    <div class="flex bg-white rounded-lg border border-gray-300 focus-within:ring-2 focus-within:ring-blue-500 overflow-hidden transition-all">
                        ...
                        <input v-model="form.email" type="email" placeholder="Correo electrónico" class="w-full px-4 py-3 bg-transparent focus:outline-none text-gray-900 placeholder-gray-400" required>
                    </div>
                    ...
                    <div class="flex bg-white rounded-lg border border-gray-300 focus-within:ring-2 focus-within:ring-blue-500 overflow-hidden transition-all">
                        ...
                        <input v-model="form.password" type="password" placeholder="Contraseña" class="w-full px-4 py-3 bg-transparent focus:outline-none text-gray-900 placeholder-gray-400" required>
                    </div>
