    ...
    >
        ...
        >
            ...
            >
                ...
                <div
                    class="aspect-335-364 relative -mb-px w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-109.5 lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002]"
                >
                    <!-- Laravel Logo -->
                    <svg
