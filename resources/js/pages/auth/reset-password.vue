                ...
                <form @submit.prevent="submit" class="space-y-4">
                    ...
                    <div class="flex bg-white rounded-lg border border-gray-300 focus-within:ring-2 focus-within:ring-blue-500 overflow-hidden transition-all">
                        ...
                        <input
                            ...
                            class="w-full px-4 py-2.5 text-sm bg-transparent focus:outline-none text-gray-900 placeholder-gray-500"
                            required
                        >
                    </div>
                    ...
                    <NotificationBox v-if="form.errors.password || form.errors.email || form.errors.token" :message="form.errors.password || form.errors.email || form.errors.token" :is-error="true" />
